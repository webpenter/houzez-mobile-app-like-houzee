    ...
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
                    ...
                    <View style={styles.policyContainer}>
                        <Text style={[styles.policyTitle, styles.policyTitleBlack]}>
                            Houzi - real estate app for Houzez
                        </Text>
                        <Text style={[styles.policyTitle, styles.policyTitleBlue]}>
                            Terms of service
                        </Text>
                    </View>
                    <Text style={[styles.policyDate, styles.policyTitleBlack]}>Oct 13, 2024</Text>
                </View>
